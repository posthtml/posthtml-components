...
import { match, walk } from 'posthtml/lib/api'
// const expressions = require('posthtml-expressions');
import expressions from 'posthtml-expressions'
// const findPathFromTag = require('./find-path');
import findPathFromTag from './find-path.js'
// const processProps = require('./process-props');
import processProps from './process-props.js'
// const processAttributes = require('./process-attributes');
import processAttributes from './process-attributes.js'
// const {processPushes, processStacks} = require('./process-stacks');
import { processPushes, processStacks } from './process-stacks.js'
// const {setFilledSlots, processSlotContent, processFillContent} = require('./process-slots');
import { setFilledSlots, processSlotContent, processFillContent } from './process-slots.js'
...
import isUndefined from 'lodash-es/isUndefined' // value === undefined
import isNull from 'lodash-es/isNull' // value === null
import isNil from 'lodash-es/isNil' // value == null
